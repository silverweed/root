...
static RootLsArgs ParseArgs(const char **args, int nArgs)
{
   ...
   outArgs.fFlags |= opts.GetBooleanFlag("oneColumn") * RootLsArgs::kOneColumn;
   outArgs.fFlags |= opts.GetBooleanFlag("longListing") * RootLsArgs::kLongListing;
   outArgs.fFlags |= opts.GetBooleanFlag("treeListing") * RootLsArgs::kTreeListing;
   outArgs.fFlags |= opts.GetBooleanFlag("recursiveListing") * RootLsArgs::kRecursiveListing;
   outArgs.fFlags |= opts.GetBooleanFlag("rntupleListing") * RootLsArgs::kRNTupleListing;
