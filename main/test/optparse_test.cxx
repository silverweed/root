...
TEST(OptParse, OptParseBoolean)
{
   ...
   EXPECT_TRUE(opts.GetErrors().empty());
   EXPECT_TRUE(opts.GetBooleanFlag("h"));
   EXPECT_TRUE(opts.GetBooleanFlag("help"));
   EXPECT_THROW(opts.GetFlagValue("h"), std::invalid_argument);
   EXPECT_THROW(opts.GetBooleanFlag("-h"), std::invalid_argument);
   EXPECT_THROW(opts.GetBooleanFlag("--help"), std::invalid_argument);
   EXPECT_TRUE(opts.GetBooleanFlag("f"));
   EXPECT_FALSE(opts.GetBooleanFlag("g"));
}
...
TEST(OptParse, OptParseString)
{
   ...
   EXPECT_TRUE(opts.GetErrors().empty());
   EXPECT_THROW(opts.GetBooleanFlag("foo"), std::invalid_argument);
...
TEST(OptParse, OptParseMissingArg)
{
   ...
   EXPECT_EQ(opts.GetFlagValue("foo"), "");
   EXPECT_FALSE(opts.GetBooleanFlag("b"));
}
...
TEST(OptParse, OptParseExtraArg)
{
   ...
   EXPECT_FALSE(opts.GetBooleanFlag("foo"));
}
...
TEST(OptParse, OptParseGroupedFlags)
{
   ...
   EXPECT_TRUE(opts.GetErrors().empty());
   EXPECT_TRUE(opts.GetBooleanFlag("a"));
   EXPECT_TRUE(opts.GetBooleanFlag("b"));
   EXPECT_THROW(opts.GetBooleanFlag("c"), std::invalid_argument);
...
TEST(OptParse, OnlyPositionalArgs)
{
   ...
   EXPECT_TRUE(opts.GetErrors().empty());
   EXPECT_FALSE(opts.GetBooleanFlag("a"));
...
TEST(OptParse, PositionalAtFirstPlace)
{
   ...
   EXPECT_TRUE(opts.GetErrors().empty());
   EXPECT_EQ(opts.GetFlagValue("foo"), "bar");
   EXPECT_EQ(opts.GetBooleanFlag("abc"), true);
...
TEST(OptParse, PositionalMixedWithFlags)
{
   ...
   EXPECT_TRUE(opts.GetErrors().empty());
   EXPECT_EQ(opts.GetBooleanFlag("noarg"), true);
