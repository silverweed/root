...
protected:
   ...
   virtual RNTupleLocatorAndLength CommitDatasetImpl() = 0;
...
public:
   ...
   RNTupleLocatorAndLength CommitDataset();
...
protected:
   ...
   virtual RNTupleLocatorAndLength CommitDatasetImpl(unsigned char *serializedFooter, std::uint32_t length) = 0;
