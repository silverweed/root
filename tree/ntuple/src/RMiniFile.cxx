...
ROOT::Internal::RNTupleLocatorAndLength ROOT::Internal::RNTupleFileWriter::Commit(int compression)
{
   ...
   if (auto fileProper = std::get_if<RImplTFile>(&fFile)) {
      ...
      anchorInfo.fLocator.SetPosition(fileSimple.fShared->fControlBlock->fSeekNTuple);
      ...
      if (fIsBare) {
         if (!fileSimple.fIsClone) {
            ...
            memcpy(fileSimple.fShared->fHeaderBlock + fileSimple.fShared->fControlBlock->fSeekNTuple +
                      ntupleOnDisk.GetSize(),
         ...
         if (!fileSimple.fIsClone) {
            ...
            memcpy(fileSimple.fShared->fHeaderBlock + fileSimple.fShared->fControlBlock->fSeekFileRecord,
                   &fileSimple.fShared->fControlBlock->fFileRecord,
                   fileSimple.fShared->fControlBlock->fFileRecord.GetSize());
